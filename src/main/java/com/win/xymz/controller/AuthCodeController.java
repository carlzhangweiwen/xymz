...
import com.win.xymz.common.util.ConstantUtil;
...
public class AuthCodeController{  
    ...
    @RequestMapping(value="/getAuthCodeImg", method=RequestMethod.GET)
    public void service(HttpServletRequest req, HttpServletResponse resp)  
        ...
        session.setAttribute(ConstantUtil.AUTHCODEIMG, randomCode.toString());  
