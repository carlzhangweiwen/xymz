...
public class Job {
    ...
    public Integer getSalaryUnitId() {
        return salaryUnitId;
    }

    public void setSalaryUnitId(Integer salaryUnitId) {
    ...
    public String getJobloction() {
        return jobloction;
    }

    public void setJobloction(String jobloction) {
        this.jobloction = jobloction;
    }
